...
//mymod: added
//+stolen ojdk
public class Bits {                            // package-private
...
//	}
	...
	static short getShortL(ByteBuffer bb, int bi) {
		return makeShort(bb.doGet(bi + 1),
			bb.doGet(bi));
	}
	...
	static void putShortL(ByteBuffer bb, int bi, short x) {
		bb.doPut(bi    , short0(x));
		bb.doPut(bi + 1, short1(x));
	}
	...
	static void putShortB(ByteBuffer bb, int bi, short x) {
		bb.doPut(bi    , short1(x));
		bb.doPut(bi + 1, short0(x));
	}
	...
	static void putIntL(ByteBuffer bb, int bi, int x) {
		bb.doPut(bi + 3, int3(x));
		bb.doPut(bi + 2, int2(x));
		bb.doPut(bi + 1, int1(x));
		bb.doPut(bi    , int0(x));
	}
	...
	static void putIntB(ByteBuffer bb, int bi, int x) {
		bb.doPut(bi    , int3(x));
		bb.doPut(bi + 1, int2(x));
		bb.doPut(bi + 2, int1(x));
		bb.doPut(bi + 3, int0(x));
	}
	...
	static void putLongL(ByteBuffer bb, int bi, long x) {
		bb.doPut(bi + 7, long7(x));
		bb.doPut(bi + 6, long6(x));
		bb.doPut(bi + 5, long5(x));
		bb.doPut(bi + 4, long4(x));
		bb.doPut(bi + 3, long3(x));
		bb.doPut(bi + 2, long2(x));
		bb.doPut(bi + 1, long1(x));
		bb.doPut(bi    , long0(x));
	}
	...
	static void putLongB(ByteBuffer bb, int bi, long x) {
		bb.doPut(bi    , long7(x));
		bb.doPut(bi + 1, long6(x));
		bb.doPut(bi + 2, long5(x));
		bb.doPut(bi + 3, long4(x));
		bb.doPut(bi + 4, long3(x));
		bb.doPut(bi + 5, long2(x));
		bb.doPut(bi + 6, long1(x));
		bb.doPut(bi + 7, long0(x));
	}

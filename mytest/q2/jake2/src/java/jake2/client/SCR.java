...
public final class SCR extends Globals {
    ...
    static void DrawPause() {
        huyava.awt.Dimension dim = new huyava.awt.Dimension();
     ...
     * Allow embedded \n in the string ================
     */
    static void SizeHUDString(String string, huyava.awt.Dimension dim) {
        ...
        if (true/*fps.value > 0.0f*/) {
            ...
            for (int i = 0; i < fpsvalue.length(); i++) {
                ...
                x += 8;
					...
					if((System.currentTimeMillis() - t) >= 500){t=System.currentTimeMillis();
						System.out.println("---fps2: " + fpsvalue);}
					if((System.currentTimeMillis() - t2) >= 10000){t2=System.currentTimeMillis();
						int mb = 1024*1024;
						System.out.println("***mem: "
								+ ((runtime.totalMemory() - runtime.freeMemory()) / mb)
								+ "/"
								+ (runtime.totalMemory() / mb)
								/*+ " of total " + (runtime.maxMemory() / mb)*/);}

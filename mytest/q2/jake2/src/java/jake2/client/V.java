...
public final class V extends Globals {
    ...
    static void AddParticle(float[] org, int color, float alpha) {
        ...
        c |= (int) (alpha * 255) << 24;
        particle_t.colorArray.putInt(i, c);

        i *= 3;
			ByteBuffer/*FloatBuffer*/ vertexBuf = particle_t.vertexArray;
        vertexBuf.putFloat(i++, org[0]);
        vertexBuf.putFloat(i++, org[1]);
        vertexBuf.putFloat(i++, org[2]);
    }

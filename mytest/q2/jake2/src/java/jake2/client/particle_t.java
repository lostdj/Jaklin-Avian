...
public class particle_t {
	...
	public static ByteBuffer/*FloatBuffer*/ vertexArray = Lib.newFloatBuffer(Defines.MAX_PARTICLES * 3);
	public static int[] colorTable = new int[256];
	public static ByteBuffer/*IntBuffer*/ colorArray = colorByteArray;//.asIntBuffer();

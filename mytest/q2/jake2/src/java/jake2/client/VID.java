...
import huyava.awt.Dimension;
import huyava.awt.DisplayMode;
	...
	static vidmode_t vid_modes[] =
		{
			...
			new vidmode_t("Mode 7: 1024x768", 1024, 768, 6),
			new vidmode_t("Mode 8: 1024x768", 1024, 768, 6),
			new vidmode_t("Mode 9: 1024x768", 1024, 768, 6),
			new vidmode_t("Mode 10: 1024x768", 1024, 768, 6),
			new vidmode_t("Mode 11: user", 1024, 768, 6),
...
//		vid_modes[11].width = (int)vid_width.value;
//		vid_modes[11].height = (int)vid_height.value;
		vid_modes[11].width = 800;//(int)vid_width.value;
		vid_modes[11].height = 600;//(int)vid_height.value;

...
//	}
	...
	public static ByteBuffer/*FloatBuffer*/ newFloatBuffer(int numElements) {
	  ByteBuffer bb = newByteBuffer(numElements * SIZEOF_FLOAT);
	  return bb;//.asFloatBuffer();
	}
	public static ByteBuffer/*FloatBuffer*/ newFloatBuffer(int numElements, ByteOrder order) {
	  ByteBuffer bb = newByteBuffer(numElements * SIZEOF_FLOAT, order);
	  return bb;//.asFloatBuffer();
	}
	public static ByteBuffer/*IntBuffer*/ newIntBuffer(int numElements) {
	  ByteBuffer bb = newByteBuffer(numElements * SIZEOF_INT);
	  return bb;//.asIntBuffer();
	}
	public static ByteBuffer/*IntBuffer*/ newIntBuffer(int numElements, ByteOrder order) {

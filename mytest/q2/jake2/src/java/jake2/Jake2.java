/*
-bootclasspath /mnt/zfs/levault/dev/s/myavian/out/tux-x64-fast/build/cp
*/
...
//    public static Q2DataDialog Q2Dialog;
     ...
     */
		...
		static String[] args = null;//new String[0];
...
//
	...
	static int oldtime = Timer.Milliseconds();
	static int newtime;
	static int time;
...
//							newt = System.currentTimeMillis() - t;
//							++frames;
//
//							if(newt >= 1000)
//							{
//								System.out.println("---fps1: " + ((float)newt / (float)frames));
//

...
//	abstract void GL_ScreenShot_f();
	...
	*/
	...
	void GL_DrawParticles(int num_particles) {
		...
		ByteBuffer/*FloatBuffer*/ sourceVertices = particle_t.vertexArray;
		ByteBuffer/*IntBuffer*/ sourceColors = particle_t.colorArray;
		float scale;
		int color;
	...
	void R_DrawParticles() {
		...
		if (false && gl_ext_pointparameters.value != 0.0f && qglPointParameterfEXT) {
...
//
//			glDrawArrays(GL11.GL_POINTS, 0, r_newrefdef.num_particles);
//
...
//			glEnable(GL11.GL_TEXTURE_2D);
	...
	void R_SetupGL() {
		...
		glGetFloat(GL11.GL_MODELVIEW_MATRIX, r_world_matrix);
...
//		});
	...
	protected boolean R_Init2() {
		...
		*/
		gl_config.vendor_string = glGetString(GL11.GL_VENDOR);
		VID.Printf(Defines.PRINT_ALL, "GL_VENDOR: " + gl_config.vendor_string + '\n');
		gl_config.renderer_string = glGetString(GL11.GL_RENDERER);
		VID.Printf(Defines.PRINT_ALL, "GL_RENDERER: " + gl_config.renderer_string + '\n');
		gl_config.version_string = glGetString(GL11.GL_VERSION);
		VID.Printf(Defines.PRINT_ALL, "GL_VERSION: " + gl_config.version_string + '\n');
		gl_config.extensions_string = glGetString(GL11.GL_EXTENSIONS);

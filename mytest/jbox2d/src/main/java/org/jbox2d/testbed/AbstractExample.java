...
//		}
	 ...
	 */
	public AbstractExample(TestbedMain_ _parent) {
		parent = _parent;
...
//		mouseScreen = new Vec2(parent.mouseX, parent.mouseY);
		...
		if (hasCachedCamera) {
			...
			camera = new TestbedCamera(new Vec2(-54, -5), 6, 0);
		}

		parent.g().setViewportTransform(camera.getTransform());

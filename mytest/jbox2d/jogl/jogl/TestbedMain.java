 ...
 *
 */
public class TestbedMain implements TestbedMain_, GLEventListener
{
	static { GLProfile.initSingleton(); }

	public static TestbedMain tb;
	...
	@Override
	public boolean shiftKey() {return shiftKey;}
...
//			animator.add(drawable);
	...
	public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
		GL2 gl2 = gl = drawable.getGL().getGL2();
...
//    }
    ...
    static public void main(String args[]) throws Exception
		{
			tb = new TestbedMain();
			while(tb.animator == null)Thread.sleep(1);
			tb.animator.start();
//			for(;;)Thread.sleep(1);
